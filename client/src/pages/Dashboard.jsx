    ...
    <>
      <div className="w-full h-full bg-gray-200">
        <div className="flex flex-no-wrap">
          ...
          <div className="w-full">
            {/* Navigation starts */}
            <nav className="h-16 flex items-center justify-between lg:justify-end  bg-white shadow relative z-10">
                ...
                <div className="w-1/2 hidden lg:flex">
                  <div className="w-full flex items-center pl-8 justify-end">
                    ...
                    >
                      <div className="rounded-full">
                        {profile ? (
                          <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-10 ">
                            <li className="flex w-full text-gray-600 hover:text-indigo-700 cursor-pointer items-center justify-center">
                              <button
                                onClick={handleLogout}
                      ...
                      <p className="text-gray-800 text-lg font-medium mx-3">
                        Jane Doe
                      </p>
